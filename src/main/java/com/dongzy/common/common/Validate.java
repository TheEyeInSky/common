 ...
 * <p>
 * <pre>
 * isTrue(i &gt; 0, "The value must be greater than zero: %d", i);
 * notNull(surname, "The surname must not be %s", null);
 * </pre>
 * <p>
 * <p>#ThreadSafe#</p>
 *
...
public class Validate {
     ...
     *
     * <pre>
     * isTrue(i &gt;= min &amp;&amp; i &lt;= max, "The value must be between &#37;d and &#37;d", min, max);
     * isTrue(myObject.isOk(), "The object is not okay");</pre>
     *
     * @param expression the boolean expression to check
    ...
    public static void notEmpty(final char[] array) {
        notEmpty(array, DEFAULT_NOT_EMPTY_ARRAY_EX_MESSAGE);
    }

    public static void notEmpty(final char[] array, final String message, final Object... values) {
        if (array == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (array.length == 0) {
    ...
    public static void notEmpty(final byte[] array, final String message, final Object... values) {
        if (array == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (array.length == 0) {
    ...
    public static void notEmpty(final short[] array) {
        notEmpty(array, DEFAULT_NOT_EMPTY_ARRAY_EX_MESSAGE);
    }

    public static void notEmpty(final short[] array, final String message, final Object... values) {
        if (array == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (array.length == 0) {
    ...
    public static void notEmpty(final int[] array, final String message, final Object... values) {
        if (array == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (array.length == 0) {
    ...
    public static void notEmpty(final long[] array, final String message, final Object... values) {
        if (array == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (array.length == 0) {
    ...
    public static void notEmpty(final float[] array, final String message, final Object... values) {
        if (array == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (array.length == 0) {
    ...
    public static void notEmpty(final double[] array, final String message, final Object... values) {
        if (array == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (array.length == 0) {
     ...
     * @see #notEmpty(Object[])
     */
    public static void notEmpty(final Collection<?> collection, final String message, final Object... values) {
        if (collection == null) {
            throw new NullPointerException(String.format(message, values));
        }
     ...
     * @see #notEmpty(Object[])
     */
    public static void notEmpty(final Map<?, ?> map, final String message, final Object... values) {
        if (map == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (map.isEmpty()) {
     ...
     */
    public static void notEmpty(final CharSequence chars) {
     ...
     */
    public static void notEmpty(final CharSequence chars, final String message, final Object... values) {
        if (chars == null) {
            throw new NullPointerException(String.format(message, values));
        }
        if (chars.length() == 0) {
     ...
     * @since 3.0
     */
    public static void notBlank(final CharSequence chars) {
        notBlank(chars, DEFAULT_NOT_BLANK_EX_MESSAGE);
    }
     ...
     * @since 3.0
     */
    public static void notBlank(final CharSequence chars, final String message, final Object... values) {
        if (chars == null) {
            throw new NullPointerException(String.format(message, values));
        }
     ...
     */
    public static <T> void notBlank(final T[] array) {
        notBlank(array, DEFAULT_NO_NULL_ELEMENTS_ARRAY_EX_MESSAGE);
    }
     ...
     * @see #notBlank(Object[])
     */
    public static <T> void notBlank(final T[] array, final String message, final Object... values) {
        notNull(array);
     ...
     * <pre>Validate.noNullElements(myArray);</pre>
     *
     * <p>If the collection is {@code null}, then the message in the exception
     * is &quot;The validated object is null&quot;.</p>
     *
     * <p>If the collection has a {@code null} element, then the message in the
     ...
     * @see #notBlank(Object[], String, Object...)
     */
    public static <T> void notBlank(final Collection<?> collection) {
        notBlank(collection, DEFAULT_NO_NULL_ELEMENTS_ARRAY_EX_MESSAGE);
    }
     ...
     * otherwise throwing an exception with the specified message.
     * <p>
     * <pre>Validate.noNullElements(myArray, "The collection contain null at position %d");</pre>
     *
     * <p>If the collection is {@code null}, then the message in the exception
     * is &quot;The validated object is null&quot;.</p>
     *
     * <p>If the collection has a {@code null} element, then the iteration
     * index of the invalid element is appended to the {@code values}
     * argument.</p>
     *
     * @param collection the collection to check, validated not null by this method
     * @param message    the {@link String#format(String, Object...)} exception message if invalid, not null
     * @param values     the optional values for the formatted exception message, null collection not recommended
     * @throws NullPointerException     if the collection is {@code null}
     * @throws IllegalArgumentException if an element is {@code null}
     * @see #notBlank(Object[])
     */
    public static void notBlank(final Collection<?> collection, final String message, final Object... values) {
        notNull(collection);
        int index = 0;
        for (Object object : collection) {
            if (object == null) {
                final Object[] values2 = ArrayUtils.add(values, index);
                throw new IllegalArgumentException(String.format(message, values2));
            }
            index++;
        }
     ...
     * @since 3.0
     */
    public static <T> void validIndex(final T[] array, final int index) {
        validIndex(array, index, DEFAULT_VALID_INDEX_ARRAY_EX_MESSAGE, index);
    }
     ...
     * @since 3.0
     */
    public static <T> void validIndex(final T[] array, final int index, final String message, final Object... values) {
        notNull(array);
     ...
     * @since 3.0
     */
    public static void validIndex(final Collection<?> collection, final int index) {
        validIndex(collection, index, DEFAULT_VALID_INDEX_COLLECTION_EX_MESSAGE, index);
    }
     ...
     * @since 3.0
     */
    public static void validIndex(final Collection<?> collection, final int index, final String message, final Object... values) {
        notNull(collection);
