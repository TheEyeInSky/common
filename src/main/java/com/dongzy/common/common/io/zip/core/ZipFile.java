...
public class ZipFile {
    ...
    public void createZipFile(ArrayList sourceFileList, ZipParameters parameters,
        ...
        if (!Zip4jUtil.checkListTypes(sourceFileList, InternalZipConstants.LIST_TYPE_FILE)) {
     ...
     * @throws ZipException
     */
    public void addFiles(List sourceFileList, ZipParameters parameters) throws ZipException {
