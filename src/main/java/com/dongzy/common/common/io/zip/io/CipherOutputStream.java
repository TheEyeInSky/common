...
public class CipherOutputStream extends BaseOutputStream {
    ...
    private void createFileHeader() throws ZipException {
        ...
        if (zipParameters.isSourceExternalStream()) {
            ...
            try {
                fileName = PathUtils.getRelativePath(zipParameters.getRootFolderInZip(), sourceFile.getAbsolutePath());
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
        ...
        if (StringUtils.notBlank(zipModel.getFileNameCharset())) {
        ...
        boolean isFileNameCharsetSet = StringUtils.notBlank(zipModel.getFileNameCharset());
