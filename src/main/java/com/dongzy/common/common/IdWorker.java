 ...
 * 并且效率较高，经测试，snowflake每秒能够生成几十万ID，完全满足需要。
 * <p>
...
public class IdWorker {
    ...
    //时间起始标记点，作为基准，一般取系统的最近时间（一旦确定不能变动）,当前为2018-1-1
    ...
    public IdWorker(long workerId, long datacenterId) {
        Validate.isTrue(workerId <= maxWorkerId && workerId >= 0,
                String.format("worker Id can't be greater than %d or less than 0", maxWorkerId));
        Validate.isTrue(datacenterId <= maxDatacenterId && datacenterId >= 0,
