...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    public static int reflectionHashCode(final Object object, final String... excludeFields) {
        ...
        reflectionAppend(object, clazz, builder, excludeFields);
    ...
    /**
     * <p>
     * Append a <code>hashCode</code> for an <code>Object</code> collection.
     * </p>
     *
     * @param array the array to add to the <code>collection</code>
     * @return this
     */
    public HashCodeBuilder append(final Collection<?> array) {
        if (array == null) {
            iTotal = iTotal * iConstant;
        } else {
            for (final Object element : array) {
